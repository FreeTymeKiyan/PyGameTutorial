# There are two problems in the original tutorial
# ===
# - the rabbit can move outside the screen, there is no restriction °Ã
# - used only one monster pics instead of four, there is no animation °Ã
#
# One Secret
# ===
...
while running:
	...
	angle = math.atan2(position[1] - (playerpos[1] + 32), position[0] - (playerpos[0] + 26)) # º∆À„Ω«∂»
